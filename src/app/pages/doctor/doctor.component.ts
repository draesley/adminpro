...
export class DoctorComponent implements OnInit {
  ...
  loadDoctor(id:string){
    ...
    this.doctorService.uploadDoctorById(id).subscribe(doctors => {

      console.log(doctors.hospital._id + 'este es el id del hospital de res');
      this.doctor = doctors;
      this.doctor.hospital = doctors.hospital._id;
